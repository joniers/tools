package cn.fastcampus.common.utils;
...
public class DateUtils {
    ...
    public static boolean isValidDate(String date, String pattern) {
        try {
            DateUtils.convertDate(date,pattern);
            return true;
        } catch (Exception e) {
...
//        return range.contains(currentDate);
    ...
    public static long getLong(String timeStr,String pattern) throws ParseException {
        SimpleDateFormat format = new SimpleDateFormat(pattern.trim());
        try {
...
//        Date startTime = getFirstDateOfCurrentMonth(new Date());
//        Date endTime = getLastDateOfCurrentMonth(new Date());
//
//        System.out.println(startTime);
//        System.out.println(endTime);

        // Date startMonth = DateUtil.addMonth(DateUtils.getStartOfMonth(), -12);

        //System.out.println(DateUtils.addDay(new Date(), -1));

        // System.out.println(DateUtils.convertDate("20180312220614", "yyyyMMddHHmmss"));
